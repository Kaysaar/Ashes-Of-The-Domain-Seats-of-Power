...
public class AILegalizationCondition extends PolicyApplierCondition{
    ...
    public void apply(String id) {
       if(market.getAdmin()!=null&&market.getAdmin().isAICore()){
           ...
           market.getIncomeMult().modifyMult("ai_core_legal",1.3f,"AI Legalization");

       }
       market.getIndustries().stream().filter(x->x.getAICoreId()!=null).forEach(x->x.getSupplyBonusFromOther().modifyFlat("ai_core_legal",1,"AI Legalization"));
    }
