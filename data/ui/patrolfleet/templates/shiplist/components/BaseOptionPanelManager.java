...
public class BaseOptionPanelManager implements OptionPanelInterface {
    ...
    int currOffset = 0;
    int currPage = 0;
    float bottomHeight = ShipUIData.HEIGHT_OF_OPTIONS;
    ...
    public void createDesignButtons( LinkedHashMap<String,Integer> designs) {
        buttonDesignPanel = panel.createCustomPanel(ShipUIData.WIDTH_OF_OPTIONS, 120, null);
        TooltipMakerAPI tooltipButDesigners = buttonDesignPanel.createUIElement(ShipUIData.WIDTH_OF_OPTIONS, buttonDesignPanel.getPosition().getHeight(), true);
        float currY = 1;
        for (RowData calculateAmountOfRow : ShipUIData.calculateAmountOfRows(ShipUIData.WIDTH_OF_OPTIONS,designs, 5)) {
            float x = 0;
        ...
        buttonDesignPanel.addUIElement(tooltipButDesigners).inTL(-5, 0);
        panel.addComponent(buttonDesignPanel).inTL(0, panel.getPosition().getHeight() - 185 );

    }


    public void createSizeOptions(LinkedHashMap<String, Integer> sizeInfo) {
        buttonSize = panel.createCustomPanel(ShipUIData.WIDTH_OF_OPTIONS, 30, null);
        TooltipMakerAPI tooltip = buttonSize.createUIElement(ShipUIData.WIDTH_OF_OPTIONS, 30, false);
        float padding = 5f;
        float currentX = 0;
        ...
        buttonSize.addUIElement(tooltip).inTL(-5, 0);
        panel.addComponent(buttonSize).inTL(0, panel.getPosition().getHeight() - 20);

    }
    public void createTypeOptions(LinkedHashMap<String, Integer> typeInfo) {
        buttonType = panel.createCustomPanel(ShipUIData.WIDTH_OF_OPTIONS, 80, null);
        TooltipMakerAPI tooltip = buttonType.createUIElement(ShipUIData.WIDTH_OF_OPTIONS, 30, false);
        float padding = 5f;
        float currentX = 0;
        float widthOfButton = 150;
        ...
        buttonType.addUIElement(tooltip).inTL(-5, 0);
        panel.addComponent(buttonType).inTL(0, panel.getPosition().getHeight() - 55);
    }
    ...
    public void createDesignButtonsForFleet( LinkedHashMap<String,Integer> designs) {
        ...
        panel.addComponent(buttonDesignPanel).inTL(0, YHeight + 130);
    ...
    public void createSizeOptionsForFleet(LinkedHashMap<String, Integer> sizeInfo) {
        ...
        panel.addComponent(buttonSize).inTL(0, panel.getPosition().getHeight() - 50);
    ...
    public void createTypeOptionsForFleet(LinkedHashMap<String, Integer> typeInfo) {
        ...
        panel.addComponent(buttonType).inTL(0, panel.getPosition().getHeight() - 85);
    }
    public void createSerachBarPanel() {
        ...
        panel.addComponent(panelOfSearchBar).inTL(buttonSortingPnael.getPosition().getX() + buttonSortingPnael.getPosition().getWidth() - 245, -3);
    }
    public void createSortingButtons(boolean forFighter, boolean isWeapon) {
        buttonSortingPnael = panel.createCustomPanel(ShipUIData.WIDTH_OF_OPTIONS, 20, null);
        ...
        TooltipMakerAPI tooltip = buttonSortingPnael.createUIElement(ShipUIData.WIDTH_OF_OPTIONS, 20, false);
        ArrayList<ButtonAPI> sortButtons = new ArrayList<>();
        sortButtons.add(tooltip.addAreaCheckbox(name, "Name", base, bg, bright, ShipUIData.WIDTH_OF_NAME, 20, 0f));
        if(!forFighter){
            sortButtons.add(tooltip.addAreaCheckbox("Size", "Size", base, bg, bright, ShipUIData.WIDTH_OF_SIZE, 20, 0f));
            sortButtons.add(tooltip.addAreaCheckbox("Type", "Type", base, bg, bright, ShipUIData.WIDTH_OF_TYPE, 20, 0f));
        }
        else{
            sortButtons.add(tooltip.addAreaCheckbox("Type", "Type", base, bg, bright, ShipUIData.WIDTH_OF_TYPE+ ShipUIData.WIDTH_OF_SIZE, 20, 0f));
        ...
        panel.addComponent(buttonSortingPnael).inTL(0, 20);
    }
    public void pageInitalization(CustomPanelAPI panel, int maxPages, Pair<CustomPanelAPI, ArrayList<ButtonAPI>> orders) {
        ...
        buttonPanel = panel.createCustomPanel(ShipUIData.WIDTH_OF_OPTIONS, 40, null);
        ...
        panel.addComponent(optionPanel).inTL(0, 40);
        panel.addComponent(buttonPanel).inTL(0, YHeight + 55);
    }
    public void reset(){
